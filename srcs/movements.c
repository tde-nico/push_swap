...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/01/26 09:14:23 by tde-nico          #+#    #+#             */
/*   Updated: 2022/01/26 09:52:58 by tde-nico         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_stack *stack_a, t_stack *stack_b)
{
	...
	while (--i > 0 && (stack_a->size - i) < minimal_mvt)
	{
		...
		if ((t[0] > stack_b->size / 2 && t[1] >= (stack_a->size - i) && t[1]
				< m) || (t[0] > stack_b->size / 2 && t[1] < (stack_a->size - i)
