...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/01/26 09:13:15 by tde-nico          #+#    #+#             */
/*   Updated: 2022/02/04 08:59:10 by tde-nico         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				pick_solution_2(t_program *prg, t_state *states,
					t_state *solution);
t_state			*add_states_2(t_state **states, t_state *new);
t_state			*new_empty_state_b(t_state *state, t_stack *stack_b,
					size_t max_size);
